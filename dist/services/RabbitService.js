...
class RabbitService {
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            let connect = yield amqplib_1.default.connect(`amqp://${this.RABBIT_USERNAME}:${this.RABBIT_PASS}@${this.RABBIT_HOST}:${this.RABBIT_PORT}`);
            return connect;
        });
    }
    sendMessage(queue = 'send_mail', content) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.default = new RabbitService();
